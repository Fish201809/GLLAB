...
void  EXBasicLighting::RenderGL(std::shared_ptr<ProjectionCamera> camera) {
...
void  EXBasicLighting::RenderGUI() {
...
void  EXBasicLighting::GenerateShader() {
	//Phone 着色模型
